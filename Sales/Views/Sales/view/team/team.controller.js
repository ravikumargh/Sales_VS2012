...
angular.module('AdminApp')
  .controller('TeamController', ['$scope', 'TeamService', 'UserService', '$uibModal', '$log', function ($scope, TeamService, UserService, $uibModal, $log) {
      ...
      $scope.getUserDetails = function (rowObj) {
          return _.find($scope.users, function(user) {
              return user.Id ===rowObj.row.TeamLeadId;
          });
      };
  }]);
