...
angular.module('AdminApp')
  .controller('ClientController', ['$scope', 'ClientService', 'ClientTypeService', '$uibModal', '$log',
      function ($scope, ClientService, ClientTypeService, $uibModal, $log) {
...
angular.module('AdminApp').controller('ClientModalInstanceCtrl', function ($scope, $uibModalInstance, parentScope) {
    ...
    $scope.clienttypes = parentScope.clienttypes;
