  ...
  .controller('ClientTypeController', ['$scope', 'ClientTypeService', '$uibModal', '$log', function ($scope, ClientTypeService, $uibModal, $log) {
      ...
      $scope.editClientTypeModel = function (status) {
          ...
          var modalInstance = $uibModal.open({
              ...
              templateUrl: 'ClientTypeModalContent.html',
              controller: 'ClientTypeModalInstanceCtrl',
              size: 'sm',
              animation: true,
              resolve: {
      ...
      $scope.deleteClientTypeModel = function (status) {
          ...
          var modalInstance = $uibModal.open({
              animation: $scope.animationsEnabled,
              templateUrl: 'ClientTypeDeleteConfirmationModalContent.html',
              controller: 'ClientTypeDeleteConfirmationModalInstanceControl',
              size: 'sm', 
              animation: true,
              resolve: {
                  parentScope: function () {
...
angular.module('AdminApp').controller('ClientTypeModalInstanceCtrl', function ($scope, $uibModalInstance, parentScope) {
...
angular.module('AdminApp').controller('ClientTypeDeleteConfirmationModalInstanceControl', function ($scope, $uibModalInstance, parentScope) {
