...
angular.module('AdminApp')
  .controller('StatusController', ['$scope', 'StatusService', '$uibModal', '$log', function ($scope, StatusService, $uibModal, $log) {
      ...
      $scope.deleteStatusModel = function (status) {
          ...
          var modalInstance = $uibModal.open({
              animation: $scope.animationsEnabled,
              templateUrl: 'StatusDeleteConfirmationModalContent.html',
              controller: 'StatusDeleteConfirmationModalInstanceControl',
              size: 'sm', 
              animation: true,
              resolve: {
                  parentScope: function () {
...
angular.module('AdminApp').controller('StatusModalInstanceCtrl', function ($scope, $uibModalInstance, parentScope) {
...
angular.module('AdminApp').controller('StatusDeleteConfirmationModalInstanceControl', function ($scope, $uibModalInstance, parentScope) {
