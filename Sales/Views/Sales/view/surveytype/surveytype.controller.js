...
angular.module('AdminApp')
  .controller('SurveyTypeController', ['$scope', 'SurveyTypeService', '$uibModal', '$log', function ($scope, SurveyTypeService, $uibModal, $log) {
      ...
      $scope.deleteSurveyType = function (status) {
          SurveyTypeService.deleteSurveyType(status.Survey_Type_ID).then(function (response) {
      ...
      $scope.editSurveyTypeModel = function (status) {
          ...
          var modalInstance = $uibModal.open({
              ...
              templateUrl: 'SurveyTypeModalContent.html',
              controller: 'SurveyTypeModalInstanceCtrl',
              size: 'sm',
              animation: true,
              resolve: {
      ...
      $scope.deleteSurveyTypeModel = function (status) {
          ...
          var modalInstance = $uibModal.open({
              ...
              controller: 'SurveyTypeDeleteConfirmationModalInstanceControl',
              size: 'sm', 
              animation: true,
              resolve: {
                  parentScope: function () {
...
angular.module('AdminApp').controller('SurveyTypeModalInstanceCtrl', function ($scope, $uibModalInstance, parentScope) {
...
angular.module('AdminApp').controller('SurveyTypeDeleteConfirmationModalInstanceControl', function ($scope, $uibModalInstance, parentScope) {
